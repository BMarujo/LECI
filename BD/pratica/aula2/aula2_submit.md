...
Produto: Código, Nome, Preço, taxa de IVA, número de unidades	
PK: Código

Encomenda: Número de encomenda, data, fornecedor código
PK: Número de encomenda
FK: fornecedor código

Fornecedor: Nome, número de identificação fiscal, endereço, número de fax, condições de pagamento, código interno do tipo de fornecedor
PK: número de identificação fiscal 
FK: código interno do tipo de fornecedor, condição de pagamento

Condições de pagamento: condição
PK: condição

Tipo Fornecedor: Código, designação
PK: Código
...
Produto -> Encomenda : Encomenda contém um ou mais itens (i.e. produtos)

Encomenda -> Fornecedor : Uma encomenda tem um fornecedor único

Fornecedor -> Tipo Fornecedor : Cada fornecedor tem um tipo fornecedor

Fornecedor -> Condições de pagamento : Cada fornecedor tem condições de pagamento

Fornecedor -> Tipo Fornecedor : Cada fornecedor é um tipo fornecedor
...
```
Produto -> Encomenda : (N:1) N produtos podem estar numa encomenda.
Encomenda precisa de ter pelo menos 1 produto.

Encomenda -> Fornecedor : (N:1) Fornecedor pode ter várias encomendas.
Encomenda precisa de ter um fornecedor.

Fornecedor -> Tipo Fornecedor : (N:1) Vários fornecedores podem ser o mesmo tipo de fornecedor.
Fornecedor precisa de ser um tipo de fornecedor.


Fornecedor -> Condições de pagamento : (N:1) Vários fornecedores podem ter a mesma condição de pagamento.
Fornecedor precisa de ter uma condição de pagamento.

Grau:
O grau é binário em todas as relações.
