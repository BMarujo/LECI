...
ARCHITECTURE structure OF DisplayDemo1 IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
-- Equation(s):
-- \system_core|decOut_n~6_combout\ = (\SW[3]~input_o\ & (\SW[0]~input_o\ & (\SW[1]~input_o\ $ (\SW[2]~input_o\)))) # (!\SW[3]~input_o\ & (!\SW[1]~input_o\ & (\SW[2]~input_o\ $ (\SW[0]~input_o\))))
...
-- Equation(s):
-- \system_core|decOut_n~9_combout\ = (\SW[3]~input_o\ & (\SW[1]~input_o\ & (!\SW[2]~input_o\ & \SW[0]~input_o\))) # (!\SW[3]~input_o\ & (\SW[2]~input_o\ & (\SW[1]~input_o\ $ (\SW[0]~input_o\))))
...
-- Equation(s):
-- \system_core|decOut_n~10_combout\ = (\system_core|decOut_n~9_combout\) # ((\system_core|decOut_n~8_combout\) # (!\KEY[0]~input_o\))
...
PORT MAP (
	...
	datab => \system_core|decOut_n~8_combout\,
	datac => \KEY[0]~input_o\,
...
-- Equation(s):
-- \system_core|decOut_n~11_combout\ = (!\SW[3]~input_o\ & (\SW[1]~input_o\ & (!\SW[2]~input_o\ & !\SW[0]~input_o\)))
...
-- Equation(s):
-- \system_core|decOut_n~12_combout\ = (\system_core|decOut_n~11_combout\) # ((\system_core|decOut_n~8_combout\) # (!\KEY[0]~input_o\))
