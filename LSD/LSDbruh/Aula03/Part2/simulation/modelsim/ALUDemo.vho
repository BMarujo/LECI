...
SIGNAL \alu|Mod0|auto_generated|divider|divider|StageOut[15]~6_combout\ : std_logic;
...
SIGNAL \alu|Add0~5_cout\ : std_logic;
...
SIGNAL \alu|Mod0|auto_generated|divider|divider|StageOut[13]~8_combout\ : std_logic;
...
-- Equation(s):
-- \alu|Mult0|auto_generated|cs2a[1]~0_combout\ = \SW[1]~input_o\ $ (\SW[2]~input_o\)
...
-- Equation(s):
-- \alu|Mult0|auto_generated|le4a\(3) = (\alu|Mult0|auto_generated|cs2a[1]~0_combout\ & (\SW[7]~input_o\ $ ((\alu|Mult0|auto_generated|le4a\(5))))) # (!\alu|Mult0|auto_generated|cs2a[1]~0_combout\ & (((\alu|Mult0|auto_generated|le4a\(5) & 
-- !\SW[6]~input_o\))))
...
-- Equation(s):
-- \alu|Mult0|auto_generated|le4a\(2) = (\alu|Mult0|auto_generated|cs2a[1]~0_combout\ & ((\SW[6]~input_o\ $ (\alu|Mult0|auto_generated|le4a\(5))))) # (!\alu|Mult0|auto_generated|cs2a[1]~0_combout\ & (!\SW[5]~input_o\ & 
...
-- Equation(s):
-- \alu|Mult0|auto_generated|le3a\(3) = (\SW[0]~input_o\ & (\SW[1]~input_o\ $ (((\SW[7]~input_o\))))) # (!\SW[0]~input_o\ & (\SW[1]~input_o\ & (!\SW[6]~input_o\)))
...
-- Equation(s):
-- \alu|Mult0|auto_generated|le3a\(2) = (\SW[0]~input_o\ & (\SW[1]~input_o\ $ (((\SW[6]~input_o\))))) # (!\SW[0]~input_o\ & (\SW[1]~input_o\ & (!\SW[5]~input_o\)))
...
-- Equation(s):
-- \alu|Mult0|auto_generated|le4a\(0) = \SW[3]~input_o\ $ (((\SW[1]~input_o\ & ((\SW[4]~input_o\) # (\SW[2]~input_o\))) # (!\SW[1]~input_o\ & (\SW[4]~input_o\ & \SW[2]~input_o\))))
...
-- Equation(s):
-- \alu|Mult0|auto_generated|le3a\(0) = \SW[1]~input_o\ $ (((\SW[0]~input_o\ & \SW[4]~input_o\)))
...
-- Equation(s):
-- \alu|Mult0|auto_generated|op_3~10_combout\ = (\alu|Mult0|auto_generated|op_1~6_combout\ & ((\SW[1]~input_o\ & (\alu|Mult0|auto_generated|op_3~9\ & VCC)) # (!\SW[1]~input_o\ & (!\alu|Mult0|auto_generated|op_3~9\)))) # 
-- (!\alu|Mult0|auto_generated|op_1~6_combout\ & ((\SW[1]~input_o\ & (!\alu|Mult0|auto_generated|op_3~9\)) # (!\SW[1]~input_o\ & ((\alu|Mult0|auto_generated|op_3~9\) # (GND)))))
-- \alu|Mult0|auto_generated|op_3~11\ = CARRY((\alu|Mult0|auto_generated|op_1~6_combout\ & (!\SW[1]~input_o\ & !\alu|Mult0|auto_generated|op_3~9\)) # (!\alu|Mult0|auto_generated|op_1~6_combout\ & ((!\alu|Mult0|auto_generated|op_3~9\) # (!\SW[1]~input_o\))))
...
\alu|m[3]~8\ : cycloneive_lcell_comb
-- Equation(s):
-- \alu|m[3]~8_combout\ = (\SW[9]~input_o\ & (!\SW[10]~input_o\ & (!\SW[8]~input_o\ & \alu|Mult0|auto_generated|op_3~14_combout\)))
...
PORT MAP (
	...
	datab => \SW[10]~input_o\,
	datac => \SW[8]~input_o\,
	datad => \alu|Mult0|auto_generated|op_3~14_combout\,
	combout => \alu|m[3]~8_combout\);

-- Location: LCCOMB_X112_Y14_N14
\alu|m[2]~9\ : cycloneive_lcell_comb
-- Equation(s):
-- \alu|m[2]~9_combout\ = (\SW[9]~input_o\ & (!\SW[10]~input_o\ & (!\SW[8]~input_o\ & \alu|Mult0|auto_generated|op_3~12_combout\)))
...
PORT MAP (
	...
	combout => \alu|m[2]~9_combout\);

-- Location: LCCOMB_X112_Y14_N0
\alu|m[1]~10\ : cycloneive_lcell_comb
-- Equation(s):
-- \alu|m[1]~10_combout\ = (\alu|Mult0|auto_generated|op_3~10_combout\ & (!\SW[10]~input_o\ & (!\SW[8]~input_o\ & \SW[9]~input_o\)))
...
PORT MAP (
	...
	datac => \SW[8]~input_o\,
	datad => \SW[9]~input_o\,
	combout => \alu|m[1]~10_combout\);

-- Location: LCCOMB_X112_Y14_N26
\alu|m[0]~11\ : cycloneive_lcell_comb
-- Equation(s):
-- \alu|m[0]~11_combout\ = (\alu|Mult0|auto_generated|op_3~8_combout\ & (!\SW[10]~input_o\ & (!\SW[8]~input_o\ & \SW[9]~input_o\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \alu|Mult0|auto_generated|op_3~8_combout\,
	datab => \SW[10]~input_o\,
	datac => \SW[8]~input_o\,
	datad => \SW[9]~input_o\,
	combout => \alu|m[0]~11_combout\);

-- Location: LCCOMB_X113_Y15_N0
\alu|Mod0|auto_generated|divider|divider|StageOut[5]~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \alu|Mod0|auto_generated|divider|divider|StageOut[5]~0_combout\ = (\SW[0]~input_o\ & (!\SW[6]~input_o\ & \SW[1]~input_o\)) # (!\SW[0]~input_o\ & ((!\SW[1]~input_o\)))
...
-- Equation(s):
-- \alu|Mod0|auto_generated|divider|divider|StageOut[5]~1_combout\ = (\SW[7]~input_o\ & ((\SW[3]~input_o\) # ((\SW[2]~input_o\) # (\alu|Mod0|auto_generated|divider|divider|StageOut[5]~0_combout\))))
...
PORT MAP (
	...
	datab => \SW[7]~input_o\,
	datac => \SW[2]~input_o\,
	datad => \alu|Mod0|auto_generated|divider|divider|StageOut[5]~0_combout\,
...
-- Equation(s):
-- \alu|Mod0|auto_generated|divider|divider|selnose[5]~0_combout\ = (\SW[2]~input_o\) # ((\SW[3]~input_o\) # ((\SW[1]~input_o\ & !\SW[7]~input_o\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \alu|Mod0|auto_generated|divider|divider|selnose[5]~0_combout\,
	datab => \SW[0]~input_o\,
	datac => \SW[6]~input_o\,
...
-- Equation(s):
-- \alu|Mod0|auto_generated|divider|divider|add_sub_2_result_int[1]~2_combout\ = (\SW[1]~input_o\ & ((\alu|Mod0|auto_generated|divider|divider|StageOut[4]~2_combout\ & (!\alu|Mod0|auto_generated|divider|divider|add_sub_2_result_int[0]~1\)) # 
-- (!\alu|Mod0|auto_generated|divider|divider|StageOut[4]~2_combout\ & ((\alu|Mod0|auto_generated|divider|divider|add_sub_2_result_int[0]~1\) # (GND))))) # (!\SW[1]~input_o\ & ((\alu|Mod0|auto_generated|divider|divider|StageOut[4]~2_combout\ & 
...
-- \alu|Mod0|auto_generated|divider|divider|add_sub_2_result_int[1]~3\ = CARRY((\SW[1]~input_o\ & ((!\alu|Mod0|auto_generated|divider|divider|add_sub_2_result_int[0]~1\) # (!\alu|Mod0|auto_generated|divider|divider|StageOut[4]~2_combout\))) # 
-- (!\SW[1]~input_o\ & (!\alu|Mod0|auto_generated|divider|divider|StageOut[4]~2_combout\ & !\alu|Mod0|auto_generated|divider|divider|add_sub_2_result_int[0]~1\)))
...
-- Equation(s):
-- \alu|Mod0|auto_generated|divider|divider|add_sub_2_result_int[2]~4_combout\ = ((\alu|Mod0|auto_generated|divider|divider|StageOut[5]~1_combout\ $ (\SW[2]~input_o\ $ (\alu|Mod0|auto_generated|divider|divider|add_sub_2_result_int[1]~3\)))) # (GND)
-- \alu|Mod0|auto_generated|divider|divider|add_sub_2_result_int[2]~5\ = CARRY((\alu|Mod0|auto_generated|divider|divider|StageOut[5]~1_combout\ & ((!\alu|Mod0|auto_generated|divider|divider|add_sub_2_result_int[1]~3\) # (!\SW[2]~input_o\))) # 
-- (!\alu|Mod0|auto_generated|divider|divider|StageOut[5]~1_combout\ & (!\SW[2]~input_o\ & !\alu|Mod0|auto_generated|divider|divider|add_sub_2_result_int[1]~3\)))
...
-- Equation(s):
-- \alu|Mod0|auto_generated|divider|divider|StageOut[10]~3_combout\ = (\alu|Mod0|auto_generated|divider|divider|add_sub_2_result_int[3]~6_combout\ & (\alu|Mod0|auto_generated|divider|divider|StageOut[5]~1_combout\)) # 
-- (!\alu|Mod0|auto_generated|divider|divider|add_sub_2_result_int[3]~6_combout\ & ((\SW[3]~input_o\ & (\alu|Mod0|auto_generated|divider|divider|StageOut[5]~1_combout\)) # (!\SW[3]~input_o\ & 
...
-- pragma translate_on
PORT MAP (
	dataa => \alu|Mod0|auto_generated|divider|divider|add_sub_2_result_int[1]~2_combout\,
	datab => \alu|Mod0|auto_generated|divider|divider|StageOut[4]~2_combout\,
	datac => \alu|Mod0|auto_generated|divider|divider|add_sub_2_result_int[3]~6_combout\,
	datad => \SW[3]~input_o\,
...
-- Equation(s):
-- \alu|Mod0|auto_generated|divider|divider|add_sub_3_result_int[0]~0_combout\ = (\SW[4]~input_o\ & ((GND) # (!\SW[0]~input_o\))) # (!\SW[4]~input_o\ & (\SW[0]~input_o\ $ (GND)))
...
-- Equation(s):
-- \alu|Mod0|auto_generated|divider|divider|add_sub_3_result_int[2]~4_combout\ = ((\alu|Mod0|auto_generated|divider|divider|StageOut[9]~4_combout\ $ (\SW[2]~input_o\ $ (\alu|Mod0|auto_generated|divider|divider|add_sub_3_result_int[1]~3\)))) # (GND)
-- \alu|Mod0|auto_generated|divider|divider|add_sub_3_result_int[2]~5\ = CARRY((\alu|Mod0|auto_generated|divider|divider|StageOut[9]~4_combout\ & ((!\alu|Mod0|auto_generated|divider|divider|add_sub_3_result_int[1]~3\) # (!\SW[2]~input_o\))) # 
-- (!\alu|Mod0|auto_generated|divider|divider|StageOut[9]~4_combout\ & (!\SW[2]~input_o\ & !\alu|Mod0|auto_generated|divider|divider|add_sub_3_result_int[1]~3\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \alu|Mod0|auto_generated|divider|divider|StageOut[9]~4_combout\,
	datab => \SW[2]~input_o\,
	datad => VCC,
...
\alu|Mod0|auto_generated|divider|divider|StageOut[15]~6\ : cycloneive_lcell_comb
-- Equation(s):
-- \alu|Mod0|auto_generated|divider|divider|StageOut[15]~6_combout\ = (\alu|Mod0|auto_generated|divider|divider|add_sub_3_result_int[4]~8_combout\ & ((\alu|Mod0|auto_generated|divider|divider|StageOut[10]~3_combout\))) # 
...
PORT MAP (
	...
	datad => \alu|Mod0|auto_generated|divider|divider|StageOut[10]~3_combout\,
	combout => \alu|Mod0|auto_generated|divider|divider|StageOut[15]~6_combout\);

-- Location: LCCOMB_X111_Y14_N20
\alu|Mux0~4\ : cycloneive_lcell_comb
-- Equation(s):
-- \alu|Mux0~4_combout\ = (\SW[3]~input_o\ & ((\SW[9]~input_o\ $ (\SW[7]~input_o\)) # (!\SW[8]~input_o\))) # (!\SW[3]~input_o\ & ((\SW[9]~input_o\ & ((\SW[7]~input_o\))) # (!\SW[9]~input_o\ & (!\SW[8]~input_o\))))
...
-- Equation(s):
-- \alu|Mux0~5_combout\ = (\alu|Mux0~4_combout\ & ((\alu|Mod0|auto_generated|divider|divider|StageOut[15]~6_combout\) # ((\SW[9]~input_o\) # (\SW[8]~input_o\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \alu|Mod0|auto_generated|divider|divider|StageOut[15]~6_combout\,
...
-- Equation(s):
-- \alu|Mux0~1_combout\ = (\SW[10]~input_o\) # ((\SW[8]~input_o\ & \SW[9]~input_o\))
...
-- Equation(s):
-- \alu|Mod0|auto_generated|divider|divider|selnose[0]~1_combout\ = (!\SW[3]~input_o\ & !\SW[2]~input_o\)
...
-- Equation(s):
-- \alu|Mod0|auto_generated|divider|divider|selnose\(0) = (\SW[1]~input_o\) # (((!\SW[7]~input_o\ & \SW[0]~input_o\)) # (!\alu|Mod0|auto_generated|divider|divider|selnose[0]~1_combout\))
...
PORT MAP (
	dataa => \SW[1]~input_o\,
	datab => \SW[7]~input_o\,
	datac => \alu|Mod0|auto_generated|divider|divider|selnose[0]~1_combout\,
	datad => \SW[0]~input_o\,
...
-- Equation(s):
-- \alu|Add0~0_combout\ = \SW[3]~input_o\ $ (\SW[8]~input_o\)
...
-- Equation(s):
-- \alu|Add0~1_combout\ = \SW[8]~input_o\ $ (\SW[2]~input_o\)
...
-- Equation(s):
-- \alu|Add0~2_combout\ = \SW[8]~input_o\ $ (\SW[1]~input_o\)
...
-- Equation(s):
-- \alu|Add0~3_combout\ = \SW[8]~input_o\ $ (\SW[0]~input_o\)
...
-- Equation(s):
-- \alu|Add0~5_cout\ = CARRY(\SW[8]~input_o\)
...
-- Equation(s):
-- \alu|Add0~6_combout\ = (\SW[4]~input_o\ & ((\alu|Add0~3_combout\ & (\alu|Add0~5_cout\ & VCC)) # (!\alu|Add0~3_combout\ & (!\alu|Add0~5_cout\)))) # (!\SW[4]~input_o\ & ((\alu|Add0~3_combout\ & (!\alu|Add0~5_cout\)) # (!\alu|Add0~3_combout\ & 
-- ((\alu|Add0~5_cout\) # (GND)))))
-- \alu|Add0~7\ = CARRY((\SW[4]~input_o\ & (!\alu|Add0~3_combout\ & !\alu|Add0~5_cout\)) # (!\SW[4]~input_o\ & ((!\alu|Add0~5_cout\) # (!\alu|Add0~3_combout\))))
...
-- Equation(s):
-- \alu|Add0~8_combout\ = ((\alu|Add0~2_combout\ $ (\SW[5]~input_o\ $ (!\alu|Add0~7\)))) # (GND)
-- \alu|Add0~9\ = CARRY((\alu|Add0~2_combout\ & ((\SW[5]~input_o\) # (!\alu|Add0~7\))) # (!\alu|Add0~2_combout\ & (\SW[5]~input_o\ & !\alu|Add0~7\)))
...
-- Equation(s):
-- \alu|Add0~10_combout\ = (\alu|Add0~1_combout\ & ((\SW[6]~input_o\ & (\alu|Add0~9\ & VCC)) # (!\SW[6]~input_o\ & (!\alu|Add0~9\)))) # (!\alu|Add0~1_combout\ & ((\SW[6]~input_o\ & (!\alu|Add0~9\)) # (!\SW[6]~input_o\ & ((\alu|Add0~9\) # (GND)))))
-- \alu|Add0~11\ = CARRY((\alu|Add0~1_combout\ & (!\SW[6]~input_o\ & !\alu|Add0~9\)) # (!\alu|Add0~1_combout\ & ((!\alu|Add0~9\) # (!\SW[6]~input_o\))))
...
-- Equation(s):
-- \alu|Add0~12_combout\ = \alu|Add0~0_combout\ $ (\alu|Add0~11\ $ (!\SW[7]~input_o\))
...
-- Equation(s):
-- \alu|Mux0~0_combout\ = (!\SW[10]~input_o\ & \SW[9]~input_o\)
...
-- Equation(s):
-- \alu|Mux0~2_combout\ = (\alu|Mux0~0_combout\ & (((\alu|Mult0|auto_generated|op_3~6_combout\) # (\alu|Mux0~1_combout\)))) # (!\alu|Mux0~0_combout\ & (\alu|Add0~12_combout\ & ((!\alu|Mux0~1_combout\))))
...
-- Equation(s):
-- \alu|Mux0~3_combout\ = (\alu|Mux0~1_combout\ & ((\alu|Mux0~2_combout\ & ((!\alu|Mod0|auto_generated|divider|divider|selnose\(0)))) # (!\alu|Mux0~2_combout\ & (\alu|Mux0~5_combout\)))) # (!\alu|Mux0~1_combout\ & (((\alu|Mux0~2_combout\))))
...
-- Equation(s):
-- \alu|Mux1~2_combout\ = (\SW[6]~input_o\ & ((\SW[2]~input_o\ $ (\SW[9]~input_o\)) # (!\SW[8]~input_o\))) # (!\SW[6]~input_o\ & ((\SW[9]~input_o\ & (\SW[2]~input_o\)) # (!\SW[9]~input_o\ & ((!\SW[8]~input_o\)))))
...
-- Equation(s):
-- \alu|Mux1~3_combout\ = (\alu|Mux1~2_combout\ & ((\alu|Mod0|auto_generated|divider|divider|StageOut[14]~7_combout\) # ((\SW[8]~input_o\) # (\SW[9]~input_o\))))
...
PORT MAP (
	...
	datab => \alu|Mod0|auto_generated|divider|divider|StageOut[14]~7_combout\,
	datac => \SW[8]~input_o\,
	datad => \SW[9]~input_o\,
...
-- Equation(s):
-- \alu|Mux1~0_combout\ = (\alu|Mux0~0_combout\ & (((\alu|Mux0~1_combout\)))) # (!\alu|Mux0~0_combout\ & ((\alu|Mux0~1_combout\ & (\alu|Mux1~3_combout\)) # (!\alu|Mux0~1_combout\ & ((\alu|Add0~10_combout\)))))
...
-- Equation(s):
-- \alu|Mod0|auto_generated|divider|divider|selnose[5]~2_combout\ = (\alu|Mod0|auto_generated|divider|divider|selnose[5]~0_combout\) # ((!\SW[6]~input_o\ & \SW[0]~input_o\))
...
-- Equation(s):
-- \alu|Mux1~1_combout\ = (\alu|Mux1~0_combout\ & (((!\alu|Mod0|auto_generated|divider|divider|selnose[5]~2_combout\)) # (!\alu|Mux0~0_combout\))) # (!\alu|Mux1~0_combout\ & (\alu|Mux0~0_combout\ & (\alu|Mult0|auto_generated|op_3~4_combout\)))
...
PORT MAP (
	...
	datab => \alu|Mux0~0_combout\,
	datac => \alu|Mult0|auto_generated|op_3~4_combout\,
	datad => \alu|Mod0|auto_generated|divider|divider|selnose[5]~2_combout\,
...
-- Equation(s):
-- \alu|Div0|auto_generated|divider|divider|add_sub_2_result_int[1]~2_combout\ = (\SW[1]~input_o\ & ((\alu|Mod0|auto_generated|divider|divider|StageOut[4]~2_combout\ & (!\alu|Div0|auto_generated|divider|divider|add_sub_2_result_int[0]~1\)) # 
-- (!\alu|Mod0|auto_generated|divider|divider|StageOut[4]~2_combout\ & ((\alu|Div0|auto_generated|divider|divider|add_sub_2_result_int[0]~1\) # (GND))))) # (!\SW[1]~input_o\ & ((\alu|Mod0|auto_generated|divider|divider|StageOut[4]~2_combout\ & 
...
-- \alu|Div0|auto_generated|divider|divider|add_sub_2_result_int[1]~3\ = CARRY((\SW[1]~input_o\ & ((!\alu|Div0|auto_generated|divider|divider|add_sub_2_result_int[0]~1\) # (!\alu|Mod0|auto_generated|divider|divider|StageOut[4]~2_combout\))) # 
-- (!\SW[1]~input_o\ & (!\alu|Mod0|auto_generated|divider|divider|StageOut[4]~2_combout\ & !\alu|Div0|auto_generated|divider|divider|add_sub_2_result_int[0]~1\)))
...
-- Equation(s):
-- \alu|Div0|auto_generated|divider|divider|add_sub_2_result_int[2]~4_combout\ = ((\alu|Mod0|auto_generated|divider|divider|StageOut[5]~1_combout\ $ (\SW[2]~input_o\ $ (\alu|Div0|auto_generated|divider|divider|add_sub_2_result_int[1]~3\)))) # (GND)
-- \alu|Div0|auto_generated|divider|divider|add_sub_2_result_int[2]~5\ = CARRY((\alu|Mod0|auto_generated|divider|divider|StageOut[5]~1_combout\ & ((!\alu|Div0|auto_generated|divider|divider|add_sub_2_result_int[1]~3\) # (!\SW[2]~input_o\))) # 
-- (!\alu|Mod0|auto_generated|divider|divider|StageOut[5]~1_combout\ & (!\SW[2]~input_o\ & !\alu|Div0|auto_generated|divider|divider|add_sub_2_result_int[1]~3\)))
...
\alu|Mod0|auto_generated|divider|divider|StageOut[13]~8\ : cycloneive_lcell_comb
-- Equation(s):
-- \alu|Mod0|auto_generated|divider|divider|StageOut[13]~8_combout\ = (\alu|Mod0|auto_generated|divider|divider|add_sub_3_result_int[4]~8_combout\ & (\alu|Mod0|auto_generated|divider|divider|StageOut[8]~5_combout\)) # 
...
PORT MAP (
	...
	datac => \alu|Mod0|auto_generated|divider|divider|StageOut[8]~5_combout\,
	datad => \alu|Mod0|auto_generated|divider|divider|add_sub_3_result_int[1]~2_combout\,
	combout => \alu|Mod0|auto_generated|divider|divider|StageOut[13]~8_combout\);

-- Location: LCCOMB_X111_Y14_N0
\alu|Mux2~2\ : cycloneive_lcell_comb
-- Equation(s):
-- \alu|Mux2~2_combout\ = (\SW[5]~input_o\ & ((\SW[9]~input_o\ $ (\SW[1]~input_o\)) # (!\SW[8]~input_o\))) # (!\SW[5]~input_o\ & ((\SW[9]~input_o\ & ((\SW[1]~input_o\))) # (!\SW[9]~input_o\ & (!\SW[8]~input_o\))))
...
-- Equation(s):
-- \alu|Mux2~3_combout\ = (\alu|Mux2~2_combout\ & ((\alu|Mod0|auto_generated|divider|divider|StageOut[13]~8_combout\) # ((\SW[9]~input_o\) # (\SW[8]~input_o\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \alu|Mod0|auto_generated|divider|divider|StageOut[13]~8_combout\,
...
-- Equation(s):
-- \alu|Mux2~0_combout\ = (\alu|Mux0~1_combout\ & (((\alu|Mux0~0_combout\)))) # (!\alu|Mux0~1_combout\ & ((\alu|Mux0~0_combout\ & ((\alu|Mult0|auto_generated|op_3~2_combout\))) # (!\alu|Mux0~0_combout\ & (\alu|Add0~8_combout\))))
...
PORT MAP (
	...
	datad => \alu|Mult0|auto_generated|op_3~2_combout\,
	combout => \alu|Mux2~0_combout\);

-- Location: LCCOMB_X111_Y14_N8
\alu|Mux2~1\ : cycloneive_lcell_comb
-- Equation(s):
-- \alu|Mux2~1_combout\ = (\alu|Mux2~0_combout\ & (((!\alu|Mux0~1_combout\)) # (!\alu|Div0|auto_generated|divider|divider|selnose\(10)))) # (!\alu|Mux2~0_combout\ & (((\alu|Mux2~3_combout\ & \alu|Mux0~1_combout\))))
...
-- Equation(s):
-- \alu|Mux3~0_combout\ = (\alu|Mod0|auto_generated|divider|divider|add_sub_3_result_int[4]~8_combout\ & (\SW[4]~input_o\)) # (!\alu|Mod0|auto_generated|divider|divider|add_sub_3_result_int[4]~8_combout\ & ((\SW[8]~input_o\ & (\SW[4]~input_o\)) # 
-- (!\SW[8]~input_o\ & ((\alu|Mod0|auto_generated|divider|divider|add_sub_3_result_int[0]~0_combout\)))))
...
-- Equation(s):
-- \alu|Mux3~1_combout\ = (\SW[9]~input_o\ & (((\SW[8]~input_o\)))) # (!\SW[9]~input_o\ & (\alu|Mux3~0_combout\ & ((\SW[0]~input_o\) # (!\SW[8]~input_o\))))
...
-- Equation(s):
-- \alu|Mux3~2_combout\ = (\SW[9]~input_o\ & ((\SW[0]~input_o\ & ((!\SW[4]~input_o\) # (!\alu|Mux3~1_combout\))) # (!\SW[0]~input_o\ & ((\SW[4]~input_o\))))) # (!\SW[9]~input_o\ & (((\alu|Mux3~1_combout\))))
...
-- Equation(s):
-- \alu|Mux3~3_combout\ = (\alu|Mux0~0_combout\ & (((\alu|Mux0~1_combout\)))) # (!\alu|Mux0~0_combout\ & ((\alu|Mux0~1_combout\ & ((\alu|Mux3~2_combout\))) # (!\alu|Mux0~1_combout\ & (\alu|Add0~6_combout\))))
...
-- Equation(s):
-- \alu|Div0|auto_generated|divider|divider|StageOut[10]~0_combout\ = (\SW[3]~input_o\ & (\alu|Mod0|auto_generated|divider|divider|StageOut[5]~1_combout\)) # (!\SW[3]~input_o\ & ((\alu|Div0|auto_generated|divider|divider|add_sub_2_result_int[3]~6_combout\ & 
-- (\alu|Mod0|auto_generated|divider|divider|StageOut[5]~1_combout\)) # (!\alu|Div0|auto_generated|divider|divider|add_sub_2_result_int[3]~6_combout\ & ((\alu|Div0|auto_generated|divider|divider|add_sub_2_result_int[2]~4_combout\)))))
...
-- Equation(s):
-- \alu|Div0|auto_generated|divider|divider|StageOut[8]~2_combout\ = (\alu|Div0|auto_generated|divider|divider|add_sub_2_result_int[3]~6_combout\ & (\SW[5]~input_o\)) # (!\alu|Div0|auto_generated|divider|divider|add_sub_2_result_int[3]~6_combout\ & 
-- ((\SW[3]~input_o\ & (\SW[5]~input_o\)) # (!\SW[3]~input_o\ & ((\alu|Div0|auto_generated|divider|divider|add_sub_2_result_int[0]~0_combout\)))))
...
PORT MAP (
	dataa => \SW[5]~input_o\,
	datab => \alu|Div0|auto_generated|divider|divider|add_sub_2_result_int[3]~6_combout\,
	datac => \alu|Div0|auto_generated|divider|divider|add_sub_2_result_int[0]~0_combout\,
	datad => \SW[3]~input_o\,
...
-- Equation(s):
-- \alu|Div0|auto_generated|divider|divider|add_sub_3_result_int[1]~3_cout\ = CARRY((\SW[1]~input_o\ & ((!\alu|Div0|auto_generated|divider|divider|add_sub_3_result_int[0]~1_cout\) # (!\alu|Div0|auto_generated|divider|divider|StageOut[8]~2_combout\))) # 
-- (!\SW[1]~input_o\ & (!\alu|Div0|auto_generated|divider|divider|StageOut[8]~2_combout\ & !\alu|Div0|auto_generated|divider|divider|add_sub_3_result_int[0]~1_cout\)))
...
-- Equation(s):
-- \alu|Div0|auto_generated|divider|divider|add_sub_3_result_int[2]~5_cout\ = CARRY((\alu|Div0|auto_generated|divider|divider|StageOut[9]~1_combout\ & ((!\alu|Div0|auto_generated|divider|divider|add_sub_3_result_int[1]~3_cout\) # (!\SW[2]~input_o\))) # 
-- (!\alu|Div0|auto_generated|divider|divider|StageOut[9]~1_combout\ & (!\SW[2]~input_o\ & !\alu|Div0|auto_generated|divider|divider|add_sub_3_result_int[1]~3_cout\)))
...
-- Equation(s):
-- \alu|Div0|auto_generated|divider|divider|add_sub_3_result_int[3]~7_cout\ = CARRY((\SW[3]~input_o\ & ((!\alu|Div0|auto_generated|divider|divider|add_sub_3_result_int[2]~5_cout\) # (!\alu|Div0|auto_generated|divider|divider|StageOut[10]~0_combout\))) # 
-- (!\SW[3]~input_o\ & (!\alu|Div0|auto_generated|divider|divider|StageOut[10]~0_combout\ & !\alu|Div0|auto_generated|divider|divider|add_sub_3_result_int[2]~5_cout\)))
...
PORT MAP (
	dataa => \SW[3]~input_o\,
	datab => \alu|Div0|auto_generated|divider|divider|StageOut[10]~0_combout\,
	datad => VCC,
...
-- Equation(s):
-- \alu|Mux3~4_combout\ = (\alu|Mux3~3_combout\ & (((!\alu|Mux0~0_combout\) # (!\alu|Div0|auto_generated|divider|divider|add_sub_3_result_int[4]~8_combout\)))) # (!\alu|Mux3~3_combout\ & (\alu|Mult0|auto_generated|op_3~0_combout\ & ((\alu|Mux0~0_combout\))))
