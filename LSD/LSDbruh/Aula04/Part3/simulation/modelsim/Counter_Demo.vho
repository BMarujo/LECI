...
SIGNAL \inst3|decOut_n[6]~2_combout\ : std_logic;
SIGNAL \inst3|decOut_n[6]~17_combout\ : std_logic;
...
SIGNAL \inst3|decOut_n[3]~5_combout\ : std_logic;
SIGNAL \inst3|decOut_n[3]~18_combout\ : std_logic;
...
-- Equation(s):
-- \inst|s_count[3]~9_combout\ = (\SW[6]~input_o\) # ((\SW[7]~input_o\) # (\SW[4]~input_o\))
...
-- Equation(s):
-- \inst|s_count[0]~10_combout\ = (!\SW[7]~input_o\ & ((\SW[0]~input_o\) # (!\SW[6]~input_o\)))
...
-- Equation(s):
-- \inst|s_count[0]~11_combout\ = (\inst|s_count[3]~9_combout\ & (\inst|s_count[0]~10_combout\ & ((\SW[6]~input_o\) # (!\inst|s_count\(0))))) # (!\inst|s_count[3]~9_combout\ & (((\inst|s_count\(0)))))
...
-- Equation(s):
-- \inst|s_count[1]~5_combout\ = (\inst|s_count\(1) & ((\SW[5]~input_o\ & (!\inst|s_count[1]~4_cout\)) # (!\SW[5]~input_o\ & (\inst|s_count[1]~4_cout\ & VCC)))) # (!\inst|s_count\(1) & ((\SW[5]~input_o\ & ((\inst|s_count[1]~4_cout\) # (GND))) # 
-- (!\SW[5]~input_o\ & (!\inst|s_count[1]~4_cout\))))
-- \inst|s_count[1]~6\ = CARRY((\inst|s_count\(1) & (\SW[5]~input_o\ & !\inst|s_count[1]~4_cout\)) # (!\inst|s_count\(1) & ((\SW[5]~input_o\) # (!\inst|s_count[1]~4_cout\))))
...
-- Equation(s):
-- \inst|s_count[2]~7_combout\ = ((\inst|s_count\(2) $ (\SW[5]~input_o\ $ (\inst|s_count[1]~6\)))) # (GND)
-- \inst|s_count[2]~8\ = CARRY((\inst|s_count\(2) & ((!\inst|s_count[1]~6\) # (!\SW[5]~input_o\))) # (!\inst|s_count\(2) & (!\SW[5]~input_o\ & !\inst|s_count[1]~6\)))
...
-- Equation(s):
-- \inst|s_count[3]~12_combout\ = \SW[5]~input_o\ $ (\inst|s_count[2]~8\ $ (!\inst|s_count\(3)))
...
\inst3|decOut_n[6]~2\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst3|decOut_n[6]~2_combout\ = (\inst|s_count\(0) & (!\inst|s_count\(3) & (\inst|s_count\(1) $ (!\inst|s_count\(2))))) # (!\inst|s_count\(0) & (!\inst|s_count\(1) & (\inst|s_count\(2) $ (!\inst|s_count\(3)))))
...
PORT MAP (
	...
	datad => \inst|s_count\(3),
	combout => \inst3|decOut_n[6]~2_combout\);

-- Location: LCCOMB_X114_Y37_N8
\inst3|decOut_n[6]~17\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst3|decOut_n[6]~17_combout\ = (\inst3|decOut_n[6]~2_combout\) # (!\SW[4]~input_o\)
...
-- pragma translate_on
PORT MAP (
	datac => \inst3|decOut_n[6]~2_combout\,
	datad => \SW[4]~input_o\,
	combout => \inst3|decOut_n[6]~17_combout\);

-- Location: LCCOMB_X113_Y34_N16
\inst3|decOut_n~6\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst3|decOut_n~6_combout\ = (\inst|s_count\(0) & (\inst|s_count\(3) $ (((\inst|s_count\(1)) # (!\inst|s_count\(2)))))) # (!\inst|s_count\(0) & (\inst|s_count\(1) & (!\inst|s_count\(2) & !\inst|s_count\(3))))
...
-- Equation(s):
-- \inst3|decOut_n~7_combout\ = (\inst3|decOut_n~6_combout\) # (!\SW[4]~input_o\)
...
-- pragma translate_on
PORT MAP (
	datac => \inst3|decOut_n~6_combout\,
	datad => \SW[4]~input_o\,
...
-- Equation(s):
-- \inst3|decOut_n~8_combout\ = (\inst|s_count\(1) & (\inst|s_count\(0) & ((!\inst|s_count\(3))))) # (!\inst|s_count\(1) & ((\inst|s_count\(2) & ((!\inst|s_count\(3)))) # (!\inst|s_count\(2) & (\inst|s_count\(0)))))
...
-- Equation(s):
-- \inst3|decOut_n~9_combout\ = (\inst3|decOut_n~8_combout\) # (!\SW[4]~input_o\)
...
-- pragma translate_on
PORT MAP (
	datab => \inst3|decOut_n~8_combout\,
	datad => \SW[4]~input_o\,
	combout => \inst3|decOut_n~9_combout\);

-- Location: LCCOMB_X113_Y34_N10
\inst3|decOut_n[3]~5\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst3|decOut_n[3]~5_combout\ = (\inst|s_count\(1) & ((\inst|s_count\(0) & (\inst|s_count\(2))) # (!\inst|s_count\(0) & (!\inst|s_count\(2) & \inst|s_count\(3))))) # (!\inst|s_count\(1) & (!\inst|s_count\(3) & (\inst|s_count\(0) $ (\inst|s_count\(2)))))
...
PORT MAP (
	...
	datac => \inst|s_count\(2),
	datad => \inst|s_count\(3),
	combout => \inst3|decOut_n[3]~5_combout\);

-- Location: LCCOMB_X114_Y37_N10
\inst3|decOut_n[3]~18\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst3|decOut_n[3]~18_combout\ = (\inst3|decOut_n[3]~5_combout\) # (!\SW[4]~input_o\)
...
-- pragma translate_on
PORT MAP (
	datac => \inst3|decOut_n[3]~5_combout\,
	datad => \SW[4]~input_o\,
	combout => \inst3|decOut_n[3]~18_combout\);

-- Location: LCCOMB_X113_Y34_N6
\inst3|decOut_n~11\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst3|decOut_n~11_combout\ = (\inst|s_count\(2) & (\inst|s_count\(3) & ((\inst|s_count\(1)) # (!\inst|s_count\(0)))))
...
-- Equation(s):
-- \inst3|decOut_n~10_combout\ = (!\inst|s_count\(0) & (\inst|s_count\(1) & (!\inst|s_count\(2) & !\inst|s_count\(3))))
...
-- Equation(s):
-- \inst3|decOut_n~12_combout\ = (\inst3|decOut_n~11_combout\) # ((\inst3|decOut_n~10_combout\) # (!\SW[4]~input_o\))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst3|decOut_n~11_combout\,
...
-- Equation(s):
-- \inst3|decOut_n~13_combout\ = (\inst|s_count\(2) & (!\inst|s_count\(3) & (\inst|s_count\(0) $ (\inst|s_count\(1))))) # (!\inst|s_count\(2) & (\inst|s_count\(0) & (\inst|s_count\(1) & \inst|s_count\(3))))
...
-- Equation(s):
-- \inst3|decOut_n~14_combout\ = (\inst3|decOut_n~11_combout\) # ((\inst3|decOut_n~13_combout\) # (!\SW[4]~input_o\))
...
PORT MAP (
	dataa => \inst3|decOut_n~11_combout\,
	datab => \inst3|decOut_n~13_combout\,
	datad => \SW[4]~input_o\,
...
-- Equation(s):
-- \inst3|decOut_n~15_combout\ = (\inst|s_count\(2) & (!\inst|s_count\(1) & (\inst|s_count\(0) $ (!\inst|s_count\(3))))) # (!\inst|s_count\(2) & (\inst|s_count\(0) & (\inst|s_count\(1) $ (!\inst|s_count\(3)))))
...
-- Equation(s):
-- \inst3|decOut_n~16_combout\ = (\inst3|decOut_n~15_combout\) # (!\SW[4]~input_o\)
...
-- pragma translate_on
PORT MAP (
	datac => \inst3|decOut_n~15_combout\,
	datad => \SW[4]~input_o\,
