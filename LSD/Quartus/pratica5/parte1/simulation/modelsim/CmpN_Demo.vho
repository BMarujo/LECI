...
-- Design Ports Information
-- LDR[3]	=>  Location: PIN_Y23,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- LDR[2]	=>  Location: PIN_AA26,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- LDR[1]	=>  Location: PIN_V5,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- LDR[0]	=>  Location: PIN_V8,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL ww_devclrn : std_logic;
SIGNAL ww_devpor : std_logic;
SIGNAL ww_LDR : std_logic_vector(3 DOWNTO 0);
SIGNAL ww_SW : std_logic_vector(7 DOWNTO 0);
SIGNAL \LDR[3]~output_o\ : std_logic;
SIGNAL \LDR[2]~output_o\ : std_logic;
SIGNAL \LDR[1]~output_o\ : std_logic;
SIGNAL \LDR[0]~output_o\ : std_logic;
...
\LDR[3]~output\ : cycloneive_io_obuf
...
\LDR[2]~output\ : cycloneive_io_obuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
	open_drain_output => "false")
...
\LDR[1]~output\ : cycloneive_io_obuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
	open_drain_output => "false")
...
\LDR[0]~output\ : cycloneive_io_obuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
	open_drain_output => "false")
...
ww_LDR(3) <= \LDR[3]~output_o\;

ww_LDR(2) <= \LDR[2]~output_o\;

ww_LDR(1) <= \LDR[1]~output_o\;

ww_LDR(0) <= \LDR[0]~output_o\;
END structure;
