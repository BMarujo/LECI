...
function showProducts(){
    /*get the profile href to have the userId */
    ...
    .done(function( data ) {
        ...
        if (info.data.length === 0) {
            ...
            info.data.forEach(element => {
                ...
                // element = [product_name, image_path, quantity, price,id,product_quantity]
            ...
            if (info.data.length === 0) {
                ...
                info.data.forEach(element => {
                    ...
                    productRow.innerHTML = `
                        <td>
                            <div class="cart-info">
                                <img src="${element[1]}" alt="Product Image" class="img-fluid">
                                <p>${element[0]}</p>
                                <small>Stock: ${element[2]}</small>
                                <br>
                                <a href="">Remove</a>
                            </div>
                        </td>
